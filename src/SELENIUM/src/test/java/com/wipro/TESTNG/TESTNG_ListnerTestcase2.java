...
public class TESTNG_ListnerTestcase2 {
    
	//private static final Logger log = LoggerHelper.getLogger(TestNG_ListnerTestcase.class);
	
	//By using this we don't have to create LoggerHelper.java
	private static final Logger log = LogManager.getLogger(TestNG_ListnerTestcase.class);
    @Test
